              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        '${Provider.of<LoginPhoneProvider>(context, listen: false).textEditingController.text}',
                        style: TextStyle(
  ...
  Widget resend(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        await Provider.of<LoginPhoneProvider>(context, listen: false)
