...
import 'package:tiktok_app_poly/views/pages/auth/register_phone_screen.dart';
import 'package:tiktok_app_poly/views/pages/auth/verify_OTP.dart';
      ...
      try {
        ...
        if (snapshot.exists) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => RegisterPhoneScreen(uid: uid)));
        }
      } catch (error) {
